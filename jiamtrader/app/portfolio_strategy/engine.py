...
from jiamtrader.event import Event, EventEngine
from jiamtrader.trader.engine import BaseEngine, MainEngine
...
from jiamtrader.trader.event import (
    EVENT_TICK,
    EVENT_ORDER,
    EVENT_TRADE,
    EVENT_POSITION
...
from jiamtrader.trader.utility import load_json, save_json, extract_vt_symbol, round_to
from jiamtrader.trader.database import database_manager
from jiamtrader.trader.converter import OffsetConverter
...
class StrategyEngine(BaseEngine):
    ...
    def load_strategy_class(self):
        ...
        self.load_strategy_class_from_folder(path1, "jiamtrader.app.portfolio_strategy.strategies")
